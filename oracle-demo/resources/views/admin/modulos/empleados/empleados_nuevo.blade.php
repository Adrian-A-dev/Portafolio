                ...
                <div class="p-4">
                    <form action="<?= isset($action) ? $action : '' ?>" method="post" id="formulario">
                        ...
                        <div class="alert alert-primary text-center" role="alert">
                            <b><i class="fa fa-info-circle"></i> ATENCIÓN:</b><br> <span>El correo electrónico debe ser válido para que el usuario pueda recibir los pasos de activación de cuenta. <br> Contraseña por defecto: <b>12345</b></span></b>
                        </div>
                        <hr>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="cargo" id="cargo" class="form-control">
                                        ...
                                        <option value="{{$cargo->id_cargo}}" <?= old('cargo') != null &&  old('cargo') == $cargo->id_cargo ? 'selected' : '' ?>>{{strUpper($cargo->cargo)}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" readonly placeholder="Seleccione Fecha Nacimiento..." value="{{ old('fecha_nacimiento') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="rol" id="rol" class="form-control">
                                        ...
                                        <option value="{{$rol->id_rol}}" <?= old('rol') !== null && old('rol') == $rol->id_rol ? 'selected' : '' ?>>{{strUpper($rol->rol)}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-md-12  border">
                                ...
                                <div id="sucursales_div">
                                    ...
                                    <div class="row d-flex justify-content-start p-4 text-center" id="div_chk_sucursales">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 d-flex justify-content-start">
                                            <div class="form-group">
                                                <input type="checkbox" onchange="cuentaCheckbox(1, '')" class="checkbox" style="cursor:pointer;" id="sucursal_{{$sucursal->id_sucursal}}" name="sucursal[]" value="{{$sucursal->id_sucursal}}" />
                                                <label for="sucursal_{{$sucursal->id_sucursal}}" style="cursor:pointer;" class="ml-2">{{$sucursal->sucursal}}</label>
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
