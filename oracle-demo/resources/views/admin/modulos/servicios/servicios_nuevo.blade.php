            ...
            <div class="card-box mb-30">
                ...
                <div class="p-4">
                    <form action="<?= isset($action) ? $action : '' ?>" method="post" id="formulario">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre de Servicio..." value="{{ old('nombre')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="tipo_servicio" id="tipo_servicio" class="form-control">
                                        ...
                                        <option value="{{ $tipo_servicio->id_tipo_servicio }}" <?= old('tipo_servicio') != null && old('tipo_servicio') == $tipo_servicio->id_tipo_servicio ? 'selected' : '' ?>>{{$tipo_servicio->tipo_servicio}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                        ...
                        <h6 class="div_lugares" {{ old('val_lugares') == 1 ? '' : 'hidden' }}>Información de Lugares</h6>
                        <hr class="div_lugares" {{ old('val_lugares') == 1 ? '' : 'hidden' }}>
                        <div class="row div_lugares" {{ old('val_lugares') == 1 ? '' : 'hidden' }}>
                            <input type="hidden" id="val_lugares" name="val_lugares" value="{{ old('val_lugares') == 1 ? 1 : '0' }}">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="origen">Lugar Origen <span class="text-danger">*</span></label>
                                    <input type="text" name="origen" maxlength="100" id="origen" class="form-control" placeholder="Ingrese Lugar de Origen..." value="{{ old('origen')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="destino" maxlength="100" id="destino" class="form-control" placeholder="Ingrese Lugar de Destino..." value="{{ old('destino')}}">
                                    <small id="invalid_destino" class="text-danger"></small>
                                </div>
                            </div>
                        </div>
                        <h6 class="div_horarios" {{ old('val_horarios') == 1 ? '' : 'hidden' }}>Información de Horarios</h6>
                        <hr class="div_horarios" {{ old('val_horarios') == 1 ? '' : 'hidden' }}>
                        <div class="row div_horarios" {{ old('val_horarios') == 1 ? '' : 'hidden' }}>
                            <input type="hidden" id="val_horarios" name="val_horarios" value="{{ old('val_horarios') == 1 ? 1 : '0' }}">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="fecha_inicio">Fecha Inicio<span class="text-danger"></span></label>
                                    <input type="text" name="fecha_inicio" id="fecha_inicio" class="form-control" readonly placeholder="Seleccione Fecha de Inicio..." value="{{ old('fecha_inicio')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fecha_fin"  id="fecha_fin" class="form-control" readonly placeholder="Seleccione Fecha de Fin..." value="{{ old('fecha_fin')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="hora_inicio" maxlength="5" id="hora_inicio" class="form-control" placeholder="Ingrese Horario de Inicio..." value="{{ old('hora_inicio')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="hora_fin" maxlength="5" id="hora_fin" class="form-control" placeholder="Ingrese Horario de Fin..." value="{{ old('hora_fin')}}">
                                    <small id="invalid_hora_fin" class="text-danger"></small>
                                </div>
                            </div>
                        </div>
                        <h6 class="div_transportista" {{ old('val_transportista') == 1 ? '' : 'hidden' }}>Información de Transportista</h6>
                        <hr class="div_transportista" {{ old('val_transportista') == 1 ? '' : 'hidden' }}>
                        <div class="row div_transportista" {{ old('val_transportista') == 1 ? '' : 'hidden' }}>
                            <input type="hidden" id="val_transportista" name="val_transportista" value="{{ old('val_transportista') == 1 ? 1 : '0' }}">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="transportista" id="transportista" class="form-control">
                                        ...
                                        <option value="{{ $transportista->id_transportista }}" <?= old('transportista') != null && old('transportista') == $transportista->id_transportista ? 'selected' : '' ?>>{{$transportista->nombre.' '.$transportista->apellido}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="precio" maxlength="12" id="precio" class="form-control" placeholder="Ingrese Valor de Servicio..." value="{{ old('precio')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cantidad" maxlength="10" id="cantidad" class="form-control" placeholder="Ingrese Cantidad Disponibles..." value="{{ old('cantidad')}}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion_corta" id="descripcion_corta" class="form-control" maxlength="255" placeholder="Ingrese Descripción Corta..." rows="2">{{ old('descripcion_corta')}}</textarea>
...
<script>
    ...
    function ocultarCampos() {
        ...
        vaciarCampo('origen');
        vaciarCampo('destino');
        vaciarCampo('fecha_inicio');
        vaciarCampo('fecha_fin');
        vaciarCampo('hora_inicio');
        vaciarCampo('hora_fin');
        vaciarCampo('transportista');
        $("#val_lugares").val(0);
        $("#val_horarios").val(0);
