                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre de Departamento..." value="{{ old('nombre')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="sucursal" id="sucursal" class="form-control">
                                        ...
                                        <option value="{{ $sucursal->id_sucursal }}" <?= old('sucursal') != null && old('sucursal') == $sucursal->id_sucursal ? 'selected' : '' ?>>{{$sucursal->sucursal}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="anfitrion" id="anfitrion" class="form-control">
                                        ...
                                        <option value="{{ $anfitrion->id_empleado }}" <?= old('anfitrion') != null && old('anfitrion') == $anfitrion->id_empleado ? 'selected' : '' ?>>{{$anfitrion->nombre.' '.$anfitrion->apellido}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cantidad_huespedes" maxlength="2" id="cantidad_huespedes" class="form-control" placeholder="N° Huéspedes Permitidos..." value="{{ old('cantidad_huespedes')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="precio_costo" maxlength="12" id="precio_costo" class="form-control" placeholder="Valor de Departamento..." value="{{ old('precio_costo')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="precio_arriendo" maxlength="12" id="precio_arriendo" class="form-control" placeholder="Valor de Arriendo..." value="{{ old('precio_arriendo')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="estado" id="estado" class="form-control">
                                        ...
                                        <option value="{{ $estado->id_estado_departamento }}" <?= old('estado') != null && old('estado') == $estado->id_estado_departamento ? 'selected' : '' ?>>{{$estado->estado_departamento}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="nuevo" id="nuevo" class="form-control">
                                        <option value="1" <?= old('nuevo') == '1' ? 'selected' : '' ?>>SÍ</option>
                                        <option value="0" <?= old('nuevo') == '0' ? 'selected' : '' ?>>NO</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion_corta" id="descripcion_corta" class="form-control" placeholder="Ingrese Descripción Corta..." rows="2">{{ old('descripcion_corta')}}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion" id="descripcion" class="form-control" placeholder="Ingrese Descripción..." rows="5" style="resize: vertical; min-height: 100px;">{{ old('descripcion')}}</textarea>
