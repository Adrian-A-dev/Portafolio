                                ...
                                <form action="<?= isset($action) ? $action : '' ?>" method="post" id="formulario">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><input type="checkbox" <?= $reserva->id_estado_reserva > 4 ? 'disabled' : ''?> class="form-control" style="width: 20px;" id="accesorio_{{$condicion->id_accesorio}}" name="accesorio[]" {{ $condicion->checked == '1' ? 'checked' : ''}} value="{{$condicion->id_accesorio}}" /></td>
                                                            </tr>
                                                            @endforeach
                                                            @else
                                                            <tr>
                                                                <td colspan="2">
                                                                <h6 class="alert alert-danger text-center" style="font-size:14px ;"><b>Opps!... No se encontraron condiciones para mostrar. <br>Asocie accesorios al Departamento</b></h6>
                                                                </td>
                                                            </tr>
                                                            @endif
                                                        </tbody>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            ...
                                            <button class="btn btn-primary" <?= $reserva->id_estado_reserva >= 3 ? 'disabled hidden' : '' ?> type="button" id="btn_submit"><i class="fa fa-check-circle"></i> Gestionar Check-in</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <div class="modal-dialog modal-md text-center">
        <div class="modal-content ">
            <div class="modal-body">
                <i class="text-danger fa fa-2x fa-question-circle"></i>
                <hr>
                <p class="modal-title text-center">¿Estás seguro que generar Check-IN?</p>
            </div>
            <div class="modal-footer text-center">
                ...
                <button type="button" id="check_in" class="btn btn-primary"><i class="fa fa-check-circle"></i> Confirmar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
