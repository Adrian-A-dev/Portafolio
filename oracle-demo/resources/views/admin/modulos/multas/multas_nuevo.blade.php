                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="multa" id="multa" class="form-control" placeholder="Ingrese Multa..." aria-describedby="helpId" value="{{ old('multa')}}">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="tipo_multa" id="tipo_multa" class="form-control">
                            ...
                            @if(!empty($tipo_multas))
                                ...
                                <option value="{{$tipo_multa->id_tipo_multa}}" <?= (old('tipo_multa') != null && old('tipo_multa') == $tipo_multa->id_tipo_multa) ? 'selected' : '' ?> >{{strUpper($tipo_multa->tipo_multa)}}</option>
                                @endforeach
                            @endif
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="valor" id="valor" class="form-control" placeholder="Ingrese Valor..." aria-describedby="helpId" value="{{ old('valor')}}">
