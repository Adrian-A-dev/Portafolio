                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombres" id="nombres" class="form-control" placeholder="Ingrese Nombre Completo..." value="{{old('nombres')}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="vehiculo" id="vehiculo" class="form-control" placeholder="Ingrese vehiculo..." value="{{old('vehiculo')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="patente" id="patente" maxlength="8" class="form-control" placeholder="Ingrese patente..." value="{{old('patente')}}">
...
<script>
    ...
    $("#btn_submit").click(function() {
        ...
        if (rut == 1 && nombres == 1 && vehiculo == 1 && patente == 1) {
