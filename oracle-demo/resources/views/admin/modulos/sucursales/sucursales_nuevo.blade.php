                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="sucursal" id="sucursal" class="form-control" placeholder="Ingrese Nombre de Sucursal..." aria-describedby="helpId" value="{{ old('sucursal')}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="region" id="region" class="form-control">
                                ...
                                <option value="{{$region->id_region}}" <?= (old('region') != null && old('region') == $region->id_region) ? 'selected' : '' ?>>{{strUpper($region->nombre_largo)}}</option>
                                @endforeach
                                @endif
                            </select>
