                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="accesorio" id="accesorio" class="form-control" placeholder="Ingrese Nombre de Accesorio..." aria-describedby="helpId" value="{{ old('accesorio') != null ? old('accesorio') : (!empty($accesorio->accesorio) ? $accesorio->accesorio : '')  }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="estado" id="estado" class="form-control">
                                <option value="1" <?= old('estado') == '1' ? 'selected' : ($accesorio->estado == 'Y' ? 'selected' : '') ?>>Activo</option>
                                <option value="0" <?= old('estado') == '0' ? 'selected' : ($accesorio->estado == 'N' ? 'selected' : '') ?>>Inactivo</option>
                            </select>
