...
<div class="min-height-200px">
    <div class="page-header">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <a class="btn btn-primary" href="/departamentos">
    ...
    <div class="card-box mb-30">
        <div class="pd-20  text-center">
            ...
            <hr>
            <p class="alert alert-primary text-center"><b>ATENCIÓN:</b> Solo se podrán cancelar las Reservas hasta 48hrs antes de la <b>FECHA DE LLEGADA</b></p>
            <hr>
        </div>
            ...
            <table class="table stripe  nowrap text-center" id="tabla">
                ...
                <tbody>
                    ...
                    <tr id="fila_<?= $reserva->id_reserva ?>">
                        ...
                        $badge = 'badge-warning';
                        if ($reserva->id_estado_reserva == 1 && $paso == 1) {
                            $paso_estado = 'Seleccion Fechas';
                        } elseif ($reserva->id_estado_reserva == 1 && $paso == 2) {
                            $paso_estado = 'Seleccion Servicios';
                        } elseif ($reserva->id_estado_reserva == 1 && $paso == 3) {
                            $paso_estado = 'Pendiente Pago';
                        } elseif ($reserva->id_estado_reserva == 1 && $paso == 4) {
                            $paso_estado = 'Pendiente Asignación Huéspedes';
                        } else {
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    ...
                                    <?php if ($reserva->id_paso_reserva == 4) : ?>
                                        ...
                                        <a class="dropdown-item btn_asignar_<?= $reserva->id_reserva ?>" href="/gestion-reservas/reservas/{{$reserva->id_reserva}}/asignar-huespedes"><i class="dw dw-edit2"></i> Asignar Huespedes</a>
                                        @elseif($reserva->id_estado_reserva == 2)
                                        <a class="dropdown-item btn_asignar_<?= $reserva->id_reserva ?>" href="/gestion-reservas/reservas/{{$reserva->id_reserva}}/asignar-huespedes"><i class="dw dw-edit2"></i> ReAsignar Huespedes</a>
                                        @elseif($reserva->id_estado_reserva == 3)
                                        <a class="dropdown-item" href="/gestion-reservas/reservas/{{$reserva->id_reserva}}/check_in"><i class="dw dw-file"></i>Ver Check-In</a>
                                        @endif
                                        @if($paso == 4 && $reserva->id_estado_reserva <= 5)
                                        <a class="dropdown-item" href="/gestion-reservas/reservas/{{$reserva->id_reserva}}/servicios-extras"><i class="dw dw-calendar-8"></i>Contratar Servicios Extras</a>
                                        @endif
                                        <a class="dropdown-item" href="/reserva/{{$reserva->id_reserva}}/ver-detalle" target="_blank"><i class="dw dw-eye"></i> Ver Reserva</a>
                                        <a class="dropdown-item" href="/reserva/{{$reserva->id_reserva}}/download-pdf" target="_blank"><i class="dw dw-download1"></i> Descargar Comprobante</a>
                                    <?php else : ?>
