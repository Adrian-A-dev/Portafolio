    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="text-center" style="color:#fff;">
                <a class="btn btn-primary" href="{{URL_EMPRESA}}login-admin" role="button" style="color:#fff;">Ir a {{NOMBRE_APP}}</a>
            </p>
            <p style="margin-left: 10px;">
                Tu correo de Acceso es: <strong style="color: #000;">"{{$email}}"</strong> <br>
                Tu clave de Acceso es: <strong style="color: #000;">"12345"</strong> <br>Se le solicitará Cambio de contraseña al iniciar Sesion.
            </p>
