                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="sucursal" id="sucursal" value="{{ old('sucursal') != null ? old('sucursal') : (!empty($sucursal->sucursal) ? $sucursal->sucursal : '')  }}" class="form-control" placeholder="Ingrese Nombre de Sucursal..." aria-describedby="helpId">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="comuna" id="comuna" class="form-control">
                                ...
                                <option value="{{$comuna->id_comuna}}" <?= $sucursal->comuna_id_comuna == $comuna->id_comuna ? 'selected' : '' ?>>{{strUpper($comuna->comuna)}}</option>
                                @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="estado" id="estado" class="form-control">
                                <option value="1" <?= $sucursal->estado == 'Y' ? 'selected' : '' ?>>Activo</option>
                                <option value="0" <?= $sucursal->estado == 'N' ? 'selected' : '' ?>>Inactivo</option>
                            </select>
